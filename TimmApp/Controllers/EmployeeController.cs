...
namespace TimmApp.Controllers
{
    ...
    {
        private TimmDbContext db = new TimmDbContext();
        ...
        public ActionResult Create([Bind(Include="EmployeeId,Fname,Lname,PhoneNum,Email,Role,EmployedAs,ContractStartDate,ContractEndDate")] Employee employee)
        {
